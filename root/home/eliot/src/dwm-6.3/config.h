...
static const char col_blue[]        = "#2a47fc";
...
static const char *dmenu_notes_cmd[] = { "dmenu_notes", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_blue, "-sf", col_gray4, NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_n,      spawn,          {.v = dmenu_notes_cmd } },
